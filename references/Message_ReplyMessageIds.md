...
List of message IDs
### Remarks
Specifies which messages were replied to in this message.
...
If this property is [null](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/null 'https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/null'), this message isn't a reply.
