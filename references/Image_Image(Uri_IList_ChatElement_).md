...
## Image.Image(Uri, IList&lt;ChatElement&gt;) Constructor
An image file in a message.  
```csharp
public Image(System.Uri src, System.Collections.Generic.IList<Guilded.NET.Base.Chat.ChatElement> nodes);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_Image_Image(System_Uri_System_Collections_Generic_IList_Guilded_NET_Base_Chat_ChatElement_)_src'></a>
`src` [System.Uri](https://docs.microsoft.com/en-us/dotnet/api/System.Uri 'System.Uri')  
The URL to the image's source
  
<a name='Guilded_NET_Base_Chat_Image_Image(System_Uri_System_Collections_Generic_IList_Guilded_NET_Base_Chat_ChatElement_)_nodes'></a>
