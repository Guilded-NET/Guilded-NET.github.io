...
## MessageEvent.UpdateMessageAsync(IFormatProvider, string, object[]) Method
...
```
#### Parameters
<a name='Guilded_NET_Base_Events_MessageEvent_UpdateMessageAsync(System_IFormatProvider_string_object__)_provider'></a>
...
<a name='Guilded_NET_Base_Events_MessageEvent_UpdateMessageAsync(System_IFormatProvider_string_object__)_format'></a>
`format` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The composite format string
  
<a name='Guilded_NET_Base_Events_MessageEvent_UpdateMessageAsync(System_IFormatProvider_string_object__)_args'></a>
