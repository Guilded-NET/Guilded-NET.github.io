...
## ChatListItem.ChatListItem(string) Constructor
An item of an ordered or unordered list.  
```csharp
public ChatListItem(string content);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_ChatListItem_ChatListItem(string)_content'></a>
