...
## ImageCaption.ImageCaption(string) Constructor
A message explaining an image.  
```csharp
public ImageCaption(string content);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_ImageCaption_ImageCaption(string)_content'></a>
