...
## Embed.WithThumbnail(Uri, Nullable&lt;uint&gt;, Nullable&lt;uint&gt;) Method
Sets the thumbnail of the embed.  
```csharp
public Guilded.NET.Base.Embeds.Embed WithThumbnail(System.Uri url, System.Nullable<uint> width=null, System.Nullable<uint> height=null);
```
#### Parameters
<a name='Guilded_NET_Base_Embeds_Embed_WithThumbnail(System_Uri_System_Nullable_uint__System_Nullable_uint_)_url'></a>
`url` [System.Uri](https://docs.microsoft.com/en-us/dotnet/api/System.Uri 'System.Uri')  
The source URL of the thumbnail image
  
<a name='Guilded_NET_Base_Embeds_Embed_WithThumbnail(System_Uri_System_Nullable_uint__System_Nullable_uint_)_width'></a>
...
<a name='Guilded_NET_Base_Embeds_Embed_WithThumbnail(System_Uri_System_Nullable_uint__System_Nullable_uint_)_height'></a>
