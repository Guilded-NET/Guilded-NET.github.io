...
## MessageDocument.MessageDocument(IList&lt;Node&gt;) Constructor
The document of the content containing all of the nodes and information.  
```csharp
public MessageDocument(System.Collections.Generic.IList<Guilded.NET.Base.Chat.Node> nodes);
```
#### Parameters
<a name='Guilded_NET_Base_Chat_MessageDocument_MessageDocument(System_Collections_Generic_IList_Guilded_NET_Base_Chat_Node_)_nodes'></a>
