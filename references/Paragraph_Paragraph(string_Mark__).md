...
## Paragraph.Paragraph(string, Mark[]) Constructor
A line of text in a message.  
```csharp
public Paragraph(string content, params Guilded.NET.Base.Chat.Mark[] formatting);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_Paragraph_Paragraph(string_Guilded_NET_Base_Chat_Mark__)_content'></a>
`content` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The text that should be converted to text container
  
<a name='Guilded_NET_Base_Chat_Paragraph_Paragraph(string_Guilded_NET_Base_Chat_Mark__)_formatting'></a>
