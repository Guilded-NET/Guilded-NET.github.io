...
## CodeLine.CodeLine(string, object[]) Constructor
A line of code in code block node.  
```csharp
public CodeLine(string format, params object[] args);
```
#### Parameters
<a name='Guilded_NET_Base_Chat_CodeLine_CodeLine(string_object__)_format'></a>
`format` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The composite format string
  
<a name='Guilded_NET_Base_Chat_CodeLine_CodeLine(string_object__)_args'></a>
