...
```csharp
public System.Threading.Tasks.Task<Guilded.Base.Content.Message> CreateMessageAsync(string content, params Guid[] replyTo);
```
#### Parameters

<a name='Guilded.Base.Content.Message.CreateMessageAsync(string,Guid[]).content'></a>

`content` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

<a name='Guilded.Base.Content.Message.CreateMessageAsync(string,Guid[]).replyTo'></a>
