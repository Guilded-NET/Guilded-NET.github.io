...
Creates a new message in a [channel](BaseGuildedClient.CreateMessageAsync(Guid,string,bool,bool).md#Guilded.Base.BaseGuildedClient.CreateMessageAsync(Guid,string,bool,bool).channel 'Guilded.Base.BaseGuildedClient.CreateMessageAsync(Guid, string, bool, bool).channel')."
---
