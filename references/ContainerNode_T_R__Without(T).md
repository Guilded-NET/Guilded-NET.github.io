...
## ContainerNode&lt;T,R&gt;.Without(T) Method
Removes a node from [Nodes](ContainerNode_T_R__Nodes.md 'Guilded.NET.Base.Chat.ContainerNode&lt;T,R&gt;.Nodes') list.  
```csharp
public R Without(T node);
```
#### Parameters
<a name='Guilded_NET_Base_Chat_ContainerNode_T_R__Without(T)_node'></a>
