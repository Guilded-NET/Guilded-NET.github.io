...
## ImageCaption.ImageCaption(ChatElement[]) Constructor
A message explaining an image.  
```csharp
public ImageCaption(params Guilded.NET.Base.Chat.ChatElement[] nodes);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_ImageCaption_ImageCaption(Guilded_NET_Base_Chat_ChatElement__)_nodes'></a>
