...
## CodeContainer.CodeContainer(IEnumerable&lt;string&gt;) Constructor
A block with code syntax highlighting.  
```csharp
public CodeContainer(System.Collections.Generic.IEnumerable<string> lines);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_CodeContainer_CodeContainer(System_Collections_Generic_IEnumerable_string_)_lines'></a>
