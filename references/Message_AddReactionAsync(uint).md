...
#### Parameters
<a name='Guilded_NET_Base_Content_Message_AddReactionAsync(uint)_emoteId'></a>
...
### Remarks
Adds a reaction of identifier [emoteId](Message_AddReactionAsync(uint)#Guilded_NET_Base_Content_Message_AddReactionAsync(uint)_emoteId 'Guilded.NET.Base.Content.Message.AddReactionAsync(uint).emoteId') to the message.
