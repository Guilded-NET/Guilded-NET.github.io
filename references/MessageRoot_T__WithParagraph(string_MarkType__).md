...
## MessageRoot&lt;T&gt;.WithParagraph(string, MarkType[]) Method
Adds a paragraph to the message document.  
```csharp
public T WithParagraph(string content, params Guilded.NET.Base.Chat.MarkType[] formatting);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_MessageRoot_T__WithParagraph(string_Guilded_NET_Base_Chat_MarkType__)_content'></a>
`content` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The contents of the paragraph
  
<a name='Guilded_NET_Base_Chat_MessageRoot_T__WithParagraph(string_Guilded_NET_Base_Chat_MarkType__)_formatting'></a>
