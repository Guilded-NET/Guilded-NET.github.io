...
## ChatList.AddList(IList&lt;Node&gt;, bool) Method
Adds a sub-list to the [Node](Node 'Guilded.NET.Base.Chat.Node') list.  
```csharp
public Guilded.NET.Base.Chat.ChatList AddList(System.Collections.Generic.IList<Guilded.NET.Base.Chat.Node> nodes, bool isOrdered);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_ChatList_AddList(System_Collections_Generic_IList_Guilded_NET_Base_Chat_Node__bool)_nodes'></a>
...
<a name='Guilded_NET_Base_Chat_ChatList_AddList(System_Collections_Generic_IList_Guilded_NET_Base_Chat_Node__bool)_isOrdered'></a>
