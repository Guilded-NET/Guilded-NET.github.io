...
## Heading.Heading(string, bool) Constructor
A large or a small title.  
```csharp
public Heading(string content, bool isLarge=true);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_Heading_Heading(string_bool)_content'></a>
`content` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The text that should be converted to text container
  
<a name='Guilded_NET_Base_Chat_Heading_Heading(string_bool)_isLarge'></a>
