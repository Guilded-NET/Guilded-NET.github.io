...
## ContainerNode&lt;T&gt;.AddText(string, MarkType[]) Method
Adds a text container based on given string.  
```csharp
public T AddText(string content, params Guilded.NET.Base.Chat.MarkType[] formatting);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_ContainerNode_T__AddText(string_Guilded_NET_Base_Chat_MarkType__)_content'></a>
`content` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The text that text container holds
  
<a name='Guilded_NET_Base_Chat_ContainerNode_T__AddText(string_Guilded_NET_Base_Chat_MarkType__)_formatting'></a>
