...
## MessageRoot&lt;T&gt;.AddQuote(string, MarkType[]) Method
Adds a block quote to the message document.  
```csharp
public T AddQuote(string content, params Guilded.NET.Base.Chat.MarkType[] formatting);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_MessageRoot_T__AddQuote(string_Guilded_NET_Base_Chat_MarkType__)_content'></a>
`content` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The contents of the quote line
  
<a name='Guilded_NET_Base_Chat_MessageRoot_T__AddQuote(string_Guilded_NET_Base_Chat_MarkType__)_formatting'></a>
