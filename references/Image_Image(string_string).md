...
## Image.Image(string, string) Constructor
...
#### Parameters
<a name='Guilded_NET_Base_Chat_Image_Image(string_string)_src'></a>
`src` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The URL to the image's source
  
<a name='Guilded_NET_Base_Chat_Image_Image(string_string)_caption'></a>
