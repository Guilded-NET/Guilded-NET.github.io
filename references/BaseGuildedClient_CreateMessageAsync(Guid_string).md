...
### Remarks
Creates a new message with [content](BaseGuildedClient_CreateMessageAsync(Guid_string)#Guilded_NET_Base_BaseGuildedClient_CreateMessageAsync(System_Guid_string)_content 'Guilded.NET.Base.BaseGuildedClient.CreateMessageAsync(System.Guid, string).content') formatted in Markdown.
