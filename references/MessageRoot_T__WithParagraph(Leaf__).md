...
## MessageRoot&lt;T&gt;.WithParagraph(Leaf[]) Method
Adds a paragraph to the message document.  
```csharp
public T WithParagraph(params Guilded.NET.Base.Chat.Leaf[] leaves);
```

#### Parameters
<a name='Guilded_NET_Base_Chat_MessageRoot_T__WithParagraph(Guilded_NET_Base_Chat_Leaf__)_leaves'></a>
