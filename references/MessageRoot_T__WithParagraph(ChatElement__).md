...
## MessageRoot&lt;T&gt;.WithParagraph(ChatElement[]) Method
Adds a paragraph to the message document.  
```csharp
public T WithParagraph(params Guilded.NET.Base.Chat.ChatElement[] nodes);
```
#### Parameters
<a name='Guilded_NET_Base_Chat_MessageRoot_T__WithParagraph(Guilded_NET_Base_Chat_ChatElement__)_nodes'></a>
