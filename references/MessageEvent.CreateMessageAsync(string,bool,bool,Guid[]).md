---
title: CreateMessageAsync(string, bool, bool, Guid[])
layout: references
section: references
tags:
  - references
...
## MessageEvent.CreateMessageAsync(string, bool, bool, Guid[]) Method
###### **Assembly:** `Guilded.Base`<br/>**Type:** [`MessageEvent`](MessageEvent 'Guilded.Base.Events.MessageEvent')

Creates a message in the parent channel (from [ChannelId](ChannelContent_TId,TServer_.ChannelId 'Guilded.Base.Content.ChannelContent<TId,TServer>.ChannelId')).

```csharp
public System.Threading.Tasks.Task<Guilded.Base.Content.Message> CreateMessageAsync(string content, bool isPrivate=false, bool isSilent=false, params Guid[] replyTo);
```
#### Parameters

<a name='Guilded.Base.Events.MessageEvent.CreateMessageAsync(string,bool,bool,Guid[]).content'></a>

`content` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

<a name='Guilded.Base.Events.MessageEvent.CreateMessageAsync(string,bool,bool,Guid[]).isPrivate'></a>

`isPrivate` [System.Boolean](https://docs.microsoft.com/en-us/dotnet/api/System.Boolean 'System.Boolean')

<a name='Guilded.Base.Events.MessageEvent.CreateMessageAsync(string,bool,bool,Guid[]).isSilent'></a>

`isSilent` [System.Boolean](https://docs.microsoft.com/en-us/dotnet/api/System.Boolean 'System.Boolean')

<a name='Guilded.Base.Events.MessageEvent.CreateMessageAsync(string,bool,bool,Guid[]).replyTo'></a>
