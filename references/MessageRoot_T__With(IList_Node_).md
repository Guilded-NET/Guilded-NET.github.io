...
## MessageRoot&lt;T&gt;.With(IList&lt;Node&gt;) Method
Adds a list of nodes to the message document.  
```csharp
public abstract T With(System.Collections.Generic.IList<Guilded.NET.Base.Chat.Node> nodes);
```
#### Parameters
<a name='Guilded_NET_Base_Chat_MessageRoot_T__With(System_Collections_Generic_IList_Guilded_NET_Base_Chat_Node_)_nodes'></a>
